...
describe("isFive(num)", () => {
  it("should return true if the num is 5 otherwise false", () => {
    ...
    // this is testing if a number is 5.
    // will return true if it is, else otherwise
  });
});
...
describe("isOdd(number)", () => {
  ...
  // It is testing if a number is odd.
  // Returns true if it is, false otherwise
  // and throws an error if input is not a number
});
...
describe("myRange(min, max, step)", () => {
  ...
  // it returns a range of numbers, from min to max, inclusive
  // with a custom step provided
  // if a step is not provided, it uses a default step of 1
});
